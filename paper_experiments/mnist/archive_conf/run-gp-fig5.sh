...
availabilities="gp50-50-tusu-10ft gp50 gp50-50-3gps-tcsc-10ft gp50-50-tcsu-10ft gp50-25255050507575-tcsu-10ft gp50-25255050507575-tusu-10ft gp50-20304050607080-tcsu-10ft3ft gp50-20304050607080-tusu-10ft" # list of availability matrices
fine_tuning=10 # Change this to #3ft of finetuning step
# availabilities="gp50-50-tusu gp50-50-3gps-tcsc gp50-50-tcsu gp50-25255050507575-tcsu gp50-25255050507575-tusu gp50-20304050607080-tcsu gp50-20304050607080-tusu" # list of availability matrices
# fine_tuning=0 # Change this to #3ft of finetuning step
...
--logs_dir ../logs/mnist_fig5/dataseed_12345/${availability}/biased_${biased}/fedavg/alpha_${alpha}/lr_${lr}/seed_${seed} \
--seed ${seed} \
--verbose ${verbose} \
