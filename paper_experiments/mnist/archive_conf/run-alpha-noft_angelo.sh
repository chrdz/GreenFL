...
### - Only change here - ###
availabilities="alphaF50-alpha0.001-10cb alphaF50-alpha0.01-10cb alphaF50-alpha0.1-10cb alphaF50-alpha0.5-10cb alphaF50-alpha0.75-10cb alphaF50-alpha0.9-10cb alphaF50-alpha1.0-10cb" #list of availability matrices
...
--logs_dir ../logs/mnist_alphaF_var/dataseed_12345/${availability}/biased_${biased}/fedavg/alpha_${alpha}/lr_${lr}/seed_${seed} \
--seed ${seed} \
--verbose ${verbose} \
