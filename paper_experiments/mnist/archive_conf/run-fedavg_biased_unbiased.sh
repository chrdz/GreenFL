...
# # first
# availabilities="alphaF50-alpha0.1-8cb" #list of availability matrices
# biased="0" # 0:unbiased, 1:biased, 2:hybrid (unbiased except when all clients available)
# participation_folder="known"
...
# COMMENT UNKNOWN PART PROBS!!
# # third
# availabilities="alphaF50-alpha0.1-8cb" #list of availability matrices
# biased="0" # 0:unbiased, 1:biased, 2:hybrid (unbiased except when all clients available)
# unknown_participation_probs="True"
# participation_folder="unknown"

# fourth
availabilities="alphaF50-alpha0.1-8cb" #list of availability matrices
biased="1" # 0:unbiased, 1:biased, 2:hybrid (unbiased except when all clients available)
unknown_participation_probs="True"
participation_folder="unknown"
...
--logs_dir ../logs/mnist_avg_biased_unbiased/${participation_folder}/${availability}/biased_${biased}/fedavg/alpha_${alpha}/lr_${lr}/seed_${seed} \
--seed ${seed} \
--verbose ${verbose} \
