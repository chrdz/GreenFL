...
logs_folder="mnist_baselines_with_ft_bestEndFT"
...
av_mat_folder="avMat_baselines_mnist_bestEndFT"
availabilities="prob2_CAFE_1cb_1ft_160Rounds prob2_CAFE_2cb_1ft_120Rounds prob2_CAFE_3cb_1ft_100Rounds prob2_CAFE_4cb_1ft_90Rounds prob2_CAFE_5cb_1ft_100Rounds prob2_CAFE_6cb_1ft_100Rounds prob2_CAFE_7cb_1ft_120Rounds prob3_FedZero_1cb_1ft_160Rounds prob3_FedZero_2cb_1ft_120Rounds prob3_FedZero_3cb_1ft_100Rounds prob3_FedZero_4cb_1ft_90Rounds prob3_FedZero_5cb_1ft_100Rounds prob3_FedZero_6cb_1ft_100Rounds prob3_FedZero_7cb_1ft_120Rounds"
...
availability_matrix_path="../${av_mat_folder}/av-mat_${availability}.csv"
if echo "$availability" | grep -qE '[0-9]+Rounds'; then
    n_rounds=$(echo "$availability" | sed -n 's/.*-\([0-9]\+\)Rounds.*/\1/p')
    echo "Number Rounds: $n_rounds"
else
    n_rounds=200
fi
