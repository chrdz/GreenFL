#!/bin/bash
source ../../../../GreenFL/venv/bin/activate
...
### - Only change here - ###
availabilities="alphaF-0.6cb-3ft2" # list of availability matrices
...
--logs_dir ../logs/cifar10/${availability}/biased_${biased}/fedavg/alpha_${alpha}/lr_${lr}/seed_${seed} \
--seed ${seed} \
--verbose ${verbose} \
...
--logs_dir ../logs/cifar10/${availability}/biased_${biased}/fedvarp/alpha_${alpha}/lr_${lr}/seed_${seed} \
--seed ${seed} \
--verbose ${verbose} \
--availability_matrix_path ${availability_matrix_path} \
--biased ${biased} \
...
--logs_dir ../logs/cifar10/${availability}/biased_${biased}/fedstale/alpha_${alpha}/lr_${lr}/seed_${seed} \
--seed ${seed} \
--verbose ${verbose} \
--availability_matrix_path ${availability_matrix_path} \
--biased ${biased} \
